...
- `i` : Request device info in the format `Info: <max_height> <min_height> <presetcount> <current_height_in_mm> <desk_name>`
...
### 🪟 Windows
1. Download the `DeskPilot_vx.x.x_x86-64_Windows_setup.exe`.
2. Run the installer and follow the instructions.
3. The App can be set to launch on system startup.

### 🐧 Linux (AppImage)
1. Download the `DeskPilot_vx.x.x_x86-64_Linux.AppImage`.
